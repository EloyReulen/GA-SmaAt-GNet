...
class GAN_base(pl.LightningModule):
    ...
    def __init__(self, hparams):
        ...
        self.discriminator = LargePix2PixDiscriminatorCBAM(hparams=hparams, in_channels=20)
    ...
    def training_step(self, batch, batchid):
        ...
        batch = batch.squeeze().float()
        imgs = batch[:,:10,:,:]
        # flip horizontally and vertically
        imgs_flip = torch.flip(imgs,[2,3])
        tar = batch[:,10:,:,:]
        ...
        generated_imgs = self.generator(imgs, imgs_flip)
        ...
        generated_imgs = self(imgs, imgs_flip)
...
class GAN(GAN_base):
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument("--num_output_images", type=int, default=10)
    ...
    def prepare_data(self):
        ...
        self.valid_dataset = dataset(
            root='./data', download=True, transform=valid_transform
        )
