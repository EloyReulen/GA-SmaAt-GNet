...
import models.regression_GA_SmaAt_GNet_mnist as gan
...
if __name__ == "__main__":
    ...
    args.n_masks = 10
    args.n_classes = 10
    args.n_output_images = 10
    
    args.gpus = 1
    args.model = "GA-SmaAt-GNet"
    args.lr_patience = 4
    args.es_patience = 15
    # GAN options
    args.l = 0.01
    ...
    args.default_save_path = ROOT_DIR / "lightning" / "mnist" / f"{args.model}_batch-{args.batch_size}_v1.0"
